...
// 2. Inject the Global Summary Controls next to Doc No inside the heading
const newHeading = `
...
// String replace the exact old heading
const oldHeadingRegex = /<div className="reports-heading" style=\{\{ display: 'flex', justifyContent: 'space-between', alignItems:\s*'flex-start' \}\}>[\s\S]*?<div>Laser Doc No\. - WJZD00-2021020100003<\/div>\s*<\/div>\s*<\/div>/;
code = code.replace(oldHeadingRegex, newHeading);
...
console.log("Reports.js patched flawlessly from clean slate!");
