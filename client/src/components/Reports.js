      ...
      {!loading && !error && filteredRows.length > 0 && (
        <div className="report-table-wrap">
          {reportType === 'checkpoint' 
            ...
            ? <LaserChangeoverReport rows={filteredRows} laserChangeoverColumns={laserChangeoverColumns} t={t} language={language} formatDate={formatDate} formatDateTime={formatDateTime} isSuperAdmin={isSuperAdmin} onDelete={handleDeleteClick} getEngineerDisplay={getEngineerDisplay} selectedRows={selectedRows} onSelectRow={handleSelectRow} onSelectAll={handleSelectAll} />
...
function LaserChangeoverReport({ rows, laserChangeoverColumns, t, language, formatDate, formatDateTime, isSuperAdmin, onDelete, getEngineerDisplay, selectedRows, onSelectRow, onSelectAll }) {
  const [expandedRow, setExpandedRow] = useState(null);
