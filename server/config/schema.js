...
const schemaQueries = [
  `CREATE TABLE IF NOT EXISTS aoi_function_checkpoint (
    ...
    password_function_pre_aoi_before_bot BOOLEAN, password_function_pre_aoi_before_top BOOLEAN,
    password_function_pre_aoi_after_bot BOOLEAN, password_function_pre_aoi_after_top BOOLEAN,
  ...
  `ALTER TABLE aoi_function_checkpoint
    ...
    ADD COLUMN IF NOT EXISTS password_function_pre_aoi_before_bot BOOLEAN, ADD COLUMN IF NOT EXISTS password_function_pre_aoi_before_top BOOLEAN,
    ADD COLUMN IF NOT EXISTS password_function_pre_aoi_after_bot BOOLEAN, ADD COLUMN IF NOT EXISTS password_function_pre_aoi_after_top BOOLEAN,
  ...
  `ALTER TABLE aoi_technician_checklist ADD COLUMN IF NOT EXISTS group_name VARCHAR(100)`,
  `DO $$
  BEGIN
